...
public struct ContextlessFeatureContext: Sendable {

	/// Instance of ``ContextlessFeatureContext``.
	///
	/// You can use this instance as a placeholder
	/// for feature context when using ``ContextlessLoadableFeature``.
...
extension ContextlessFeatureContext: LoadableFeatureContext {
